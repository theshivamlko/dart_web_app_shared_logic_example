...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    toUpperCaseEachWord(input) {
      ...
      return B.JSArray_methods.join$1(A.List_List$of(new A.MappedListIterable(A._setArrayType(A._asString(input).split(" "), type$.JSArray_String), type$.String_Function_String._as(new A.toUpperCaseEachWord_closure()), t1), true, t1._eval$1("ListIterable.E")), " ");
    },
    toUpperCaseEachWord_closure: function toUpperCaseEachWord_closure() {
    },
  ...
  A.ListIterable.prototype = {
    get$iterator(_) {
      return new A.ListIterator(this, this._source.length, this.$ti._eval$1("ListIterator<ListIterable.E>"));
    }
  };
  A.ListIterator.prototype = {
    ...
    moveNext$0() {
      ...
      _this.set$_current(t1._f.call$1(t2[t3]));
      ++_this._index;
      return true;
    },
  ...
  A.toUpperCaseEachWord_closure.prototype = {
    call$1(word) {
      ...
      if (t1 !== 0) {
        if (0 >= t1)
          return A.ioore(word, 0);
        t1 = word[0].toUpperCase() + B.JSString_methods.substring$1(word, 1);
      } else
        t1 = "";
      return t1;
    },
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "upperCaseDartCode__toUpperCaseEachWord$closure", "toUpperCaseEachWord", 0);
  })();
...
//# sourceMappingURL=upperCaseDartCode.js.map
